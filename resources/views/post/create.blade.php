                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('store_post') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="short_description" class="col-md-4 col-form-label text-md-end">{{ __('Description') }}</label>

                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control @error('descrription') is-invalid @enderror" name="description" required autocomplete="description">
                            ...
                            <div class="row mb-3">
                                <label for="keyword" class="col-md-4 col-form-label text-md-end">{{ __('Keyword') }}</label>

                                <div class="col-md-6">
                                    <input id="keyword" type="keyword" class="form-control" name="keyword"
